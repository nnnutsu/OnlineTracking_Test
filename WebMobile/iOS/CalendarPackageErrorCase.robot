...
*** Test Cases ***
(F7_WEB_2_1_Y_2_113) Verify Not Input Mobile Number
...
(F7_WEB_2_1_Y_2_114) Input Phone Number Lessthan 10 Digits
    [Documentation]    ***Owner : Nut***
    ...
...
(F7_WEB_2_1_Y_2_115) Input Phone Number Morethan 10 Digits
    [Documentation]    ***Owner : Nut***
    ...
    ...     Status : Active
    ...     Ntype : Postpaid
...
(F7_WEB_2_1_Y_2_116) Verify Input Mobile Number By Character
    [Documentation]     ***Owner : Nut***
    ...
    ...     Status : Active
    ...     Ntype : Postpaid
...
(F7_WEB_2_1_Y_2_117) Verify Input Mobile Number By Special Character
    [Documentation]     ***Owner : Nut***
    ...
    ...     Status : Active
    ...     Ntype : Postpaid
...
(F7_WEB_2_1_Y_2_118) Verify Input Mobile Number Wrong Format
    [Documentation]     ***Owner : Nut***
    ...
    ...     Status : Active
    ...     Ntype : Postpaid
...
(F7_WEB_2_1_Y_2_119) Verify Input Phone Number as Non AIS
    [Documentation]     ***Owner : Nut***
    ...
    ...     Status : Active
    ...     Ntype : Postpaid
    ...
    Select Tab Max Speed Internet
    Register Package    100MB    9Baht    1Day
    Input Wrong Mobile Number    NumberNonAIS
    Select Request Password
    Verify Wrong Mobile Number    PleaseInputNumberAIS
    [Teardown]    Keywords For Teardown    ${#dict_device_name}

(F7_WEB_2_1_Y_2_120) Verify Not Input OTP
    [Documentation]     ***Owner : Nut***
    ...
    ...     Status : Active
    ...     Ntype : Postpaid
...
(F7_WEB_2_1_Y_2_121) Verify Input OTP Less Than 4 Digits
    [Documentation]     ***Owner : Nut***
    ...
    ...     Status : Active
    ...     Ntype : Postpaid
...
(F7_WEB_2_1_Y_2_122) Verify Input OTP More Than 4 Digits
    [Documentation]     ***Owner : Nut***
    ...
    ...     Status : Active
    ...     Ntype : Postpaid
    ...
    Mobile Capture Screen At Verify Point    WrongOTPMorethan4Digits
    [Teardown]    Keywords For Teardown    ${#dict_device_name}

(F7_WEB_2_1_Y_2_123) Verify Input OTP By Character
    [Documentation]     ***Owner : Nut***
    ...
    ...     Status : Active
    ...     Ntype : Postpaid
    ...
    Mobile Capture Screen At Verify Point    WrongOTPCharacter
    [Teardown]    Keywords For Teardown    ${#dict_device_name}

(F7_WEB_2_1_Y_2_124) Verify Input OTP By Special Character
    [Documentation]     ***Owner : Nut***
    ...
    ...     Status : Active
    ...     Ntype : Postpaid
    ...
    Mobile Capture Screen At Verify Point    WrongOTPSpecialCharacter
    [Teardown]    Keywords For Teardown    ${#dict_device_name}
    
(F7_WEB_2_1_Y_2_125) Verify Wrong OTP
    [Documentation]     ***Owner : Nut***
    ...
    ...     Status : Active
    ...     Ntype : Postpaid
...
(F7_WEB_2_1_Y_2_126) Verify Wrong OTP 3 Time
    [Documentation]     ***Owner : Nut***
    ...
    ...     Status : Active
    ...     Ntype : Postpaid
...
#(F7_WEB_2_1_Y_2_127) OTP หมดอายุ ทำไม่ได้ 
(F7_WEB_2_1_Y_2_128) Verify Not Input Friend Number 
    [Documentation]     ***Owner : Nut***
    ...
    ...     Status : Active
    ...     Ntype : Postpaid
...
(F7_WEB_2_1_Y_2_129) Verify Input Friend Number Less Than 10 Digits
    [Documentation]     ***Owner : Nut***
    ...
    ...     Status : Active
    ...     Ntype : Postpaid
...
(F7_WEB_2_1_Y_2_130) Verify Input Friend Number More Than 10 Digits
    [Documentation]     ***Owner : Nut***
    ...
    ...     Status : Active
    ...     Ntype : Postpaid
...
(F7_WEB_2_1_Y_2_131) Verify Input Friend Number as Character
    [Documentation]    ***Owner : Nut***
    ...
...
(F7_WEB_2_1_Y_2_132) Verify Input Friend Number as Special Character
    [Documentation]    ***Owner : Nut***
    ...
...
(F7_WEB_2_1_Y_2_133) Verify Input Friend Number Not Start With 0
    [Documentation]    ***Owner : Nut***
    ...
...
(F7_WEB_2_1_Y_2_134) Verify Input Friend Number By Not AIS Network
    [Documentation]     ***Owner : Nut***
    ...
    ...     Status : Active
    ...     Ntype : Postpaid
    ...
    Select Confirm Package For Friend
    Verify Result Message Error Not AIS Network    ${Number}    ${virtual_device_1_IPAppium}    ${virtual_device_1_Platfrom_Name}    ${virtual_device_1_Platfrom_Version}    ${virtual_device_1_SN}
    [Teardown]    Keywords For Teardown    ${#dict_device_name}

(F7_WEB_2_1_Y_2_135) Verify Input Friend Number Same Sender Number
    [Documentation]     ***Owner : Nut***
    ...
    ...     Status : Active
    ...     Ntype : Postpaid
