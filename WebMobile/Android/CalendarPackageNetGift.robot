...
Resource          Resource/PageKeywords/CalendarPackageNetGift.robot
...
(F4_WEB_2_1_Y_2_58) Send To Friend 1Mbps 25Baht 1Day : Prepaid to Prepaid
    ...
    ${Number_Friend}    Get From Dictionary    ${virtual_device_1_Number_b}    3PE
    ...
    Input Friend Number    ${Number_Friend}
...
(F4_WEB_2_1_Y_2_59) Send To Friend 1Mbps 25Baht 1Day : Prepaid to Postpaid
    ...
    &{#dict_device_name}=    Take And Define Virtual Local Configuration    ${#dict_device_name}    ${lo_OnlineTracking_Test_local_config_file_path}    virtual_device_1    ${ar_TAKE_TIMEOUT}    ${ar_NType}=include
    ${Number}    Get From Dictionary    ${virtual_device_1_Number}    3PE
    ${Number_Friend}    Get From Dictionary    ${virtual_device_1_Number_b}    3PO
    Open WebMobile Online Tracking     ${virtual_device_1_SN}    ${virtual_device_1_IPChromeDriver}
    Select Tab    SpecialInternet
    Select On-Top Net Gift Internet Package    1Mbps    25Baht    1Day
    Input Friend Number    ${Number_Friend}
...
(F4_WEB_2_1_Y_2_62) Send To Friend 1Mbps 120Baht 7Days : Prepaid to Prepaid
    ...
    Open WebMobile Online Tracking     ${virtual_device_1_SN}    ${virtual_device_1_IPChromeDriver}
    Select Tab    SpecialInternet
    Select On-Top Net Gift Internet Package    1Mbps    120Baht    7Day
    Input Friend Number    ${Number_Friend}
    Verify Submitted Request Via Wifi or Data    ${Number}    ${virtual_device_1_IPAppium}    ${virtual_device_1_Platfrom_Name}    ${virtual_device_1_Platfrom_Version}    ${virtual_device_1_SN}
    [Teardown]    Keywords For Teardown WebMobile    ${#dict_device_name}
...
(F4_WEB_2_1_Y_2_66) Send To Friend 1Mbps 350Baht 30Days : Prepaid to Prepaid
    ...
    Open WebMobile Online Tracking     ${virtual_device_1_SN}    ${virtual_device_1_IPChromeDriver}
    Select Tab    SpecialInternet
    Select On-Top Net Gift Internet Package    1Mbps    350Baht    30Day
    Input Friend Number    ${Number_Friend}
    Verify Submitted Request Via Wifi or Data    ${Number}    ${virtual_device_1_IPAppium}    ${virtual_device_1_Platfrom_Name}    ${virtual_device_1_Platfrom_Version}    ${virtual_device_1_SN}
    [Teardown]    Keywords For Teardown WebMobile    ${#dict_device_name}
...
(F4_WEB_2_1_Y_2_70) Send To Friend 4Mbps 32Baht 1Day : Prepaid to Prepaid
    ...
    Open WebMobile Online Tracking     ${virtual_device_1_SN}    ${virtual_device_1_IPChromeDriver}
    Select Tab    SpecialInternet
    Select On-Top Net Gift Internet Package    4Mbps    32Baht    1Day
    Input Friend Number    ${Number_Friend}
    Verify Submitted Request Via Wifi or Data    ${Number}    ${virtual_device_1_IPAppium}    ${virtual_device_1_Platfrom_Name}    ${virtual_device_1_Platfrom_Version}    ${virtual_device_1_SN}
    [Teardown]    Keywords For Teardown WebMobile    ${#dict_device_name}
...
(F4_WEB_2_1_Y_2_74) Send To Friend 4Mbps 220Baht 7Days : Prepaid to Prepaid
    ...
    Open WebMobile Online Tracking     ${virtual_device_1_SN}    ${virtual_device_1_IPChromeDriver}
    Select Tab    SpecialInternet
    Select On-Top Net Gift Internet Package    4Mbps    220Baht    7Day
    Input Friend Number    ${Number_Friend}
    Verify Submitted Request Via Wifi or Data    ${Number}    ${virtual_device_1_IPAppium}    ${virtual_device_1_Platfrom_Name}    ${virtual_device_1_Platfrom_Version}    ${virtual_device_1_SN}
    [Teardown]    Keywords For Teardown WebMobile    ${#dict_device_name}
...
(F4_WEB_2_1_Y_2_78) Send To Friend 4Mbps 650Baht 30Days : Prepaid to Prepaid
    ...
    Open WebMobile Online Tracking     ${virtual_device_1_SN}    ${virtual_device_1_IPChromeDriver}
    Select Tab    SpecialInternet
    Select On-Top Net Gift Internet Package    4Mbps    650Baht    30Day
    Input Friend Number    ${Number_Friend}
    Verify Submitted Request Via Wifi or Data    ${Number}    ${virtual_device_1_IPAppium}    ${virtual_device_1_Platfrom_Name}    ${virtual_device_1_Platfrom_Version}    ${virtual_device_1_SN}
    [Teardown]    Keywords For Teardown WebMobile    ${#dict_device_name}
...
(F4_WEB_2_1_Y_2_82) Send To Friend 6Mbps 45Baht 1Day : Prepaid to Prepaid
    ...
    Open WebMobile Online Tracking     ${virtual_device_1_SN}    ${virtual_device_1_IPChromeDriver}
    Select Tab    SpecialInternet
    Select On-Top Net Gift Internet Package    6Mbps    45Baht    1Day
    Input Friend Number    ${Number_Friend}
    Verify Submitted Request Via Wifi or Data    ${Number}    ${virtual_device_1_IPAppium}    ${virtual_device_1_Platfrom_Name}    ${virtual_device_1_Platfrom_Version}    ${virtual_device_1_SN}
    [Teardown]    Keywords For Teardown WebMobile    ${#dict_device_name}
...
(F4_WEB_2_1_Y_2_86) Send To Friend 6Mbps 270Baht 7Days : Prepaid to Prepaid
    ...
    Open WebMobile Online Tracking     ${virtual_device_1_SN}    ${virtual_device_1_IPChromeDriver}
    Select Tab    SpecialInternet
    Select On-Top Net Gift Internet Package    6Mbps    270Baht    7Day
    Input Friend Number    ${Number_Friend}
    Verify Submitted Request Via Wifi or Data    ${Number}    ${virtual_device_1_IPAppium}    ${virtual_device_1_Platfrom_Name}    ${virtual_device_1_Platfrom_Version}    ${virtual_device_1_SN}
    [Teardown]    Keywords For Teardown WebMobile    ${#dict_device_name}
...
(F4_WEB_2_1_Y_2_90) Send To Friend 6Mbps 850Baht 30Days : Prepaid to Prepaid
    ...
    Open WebMobile Online Tracking     ${virtual_device_1_SN}    ${virtual_device_1_IPChromeDriver}
    Select Tab    SpecialInternet
    Select On-Top Net Gift Internet Package    6Mbps    850Baht    30Day
    Input Friend Number    ${Number_Friend}
    Verify Submitted Request Via Wifi or Data    ${Number}    ${virtual_device_1_IPAppium}    ${virtual_device_1_Platfrom_Name}    ${virtual_device_1_Platfrom_Version}    ${virtual_device_1_SN}
    [Teardown]    Keywords For Teardown WebMobile    ${#dict_device_name}
...
(F4_WEB_2_1_Y_2_94) Send To Friend 5GB 75Baht 1Day : Prepaid to Prepaid
    ...
    Open WebMobile Online Tracking     ${virtual_device_1_SN}    ${virtual_device_1_IPChromeDriver}
    Select Tab    SpecialInternet
    Select On-Top Net Gift Internet Package 5GB    5GB    75Baht    1Day
    Input Friend Number    ${Number_Friend}
    Verify Submitted Request Via Wifi or Data    ${Number}    ${virtual_device_1_IPAppium}    ${virtual_device_1_Platfrom_Name}    ${virtual_device_1_Platfrom_Version}    ${virtual_device_1_SN}
    [Teardown]    Keywords For Teardown WebMobile    ${#dict_device_name}
...
(F4_WEB_2_1_Y_2_98) Send To Friend 5GB 150Baht 7Days : Prepaid to Prepaid
    ...
    Open WebMobile Online Tracking     ${virtual_device_1_SN}    ${virtual_device_1_IPChromeDriver}
    Select Tab    SpecialInternet
    Select On-Top Net Gift Internet Package 5GB    5GB    150Baht    7Day
    Input Friend Number    ${Number_Friend}
    Verify Submitted Request Via Wifi or Data    ${Number}    ${virtual_device_1_IPAppium}    ${virtual_device_1_Platfrom_Name}    ${virtual_device_1_Platfrom_Version}    ${virtual_device_1_SN}
    [Teardown]    Keywords For Teardown WebMobile    ${#dict_device_name}
...
(F4_WEB_2_1_Y_2_102) Send To Friend 5GB 488Baht 30Days : Prepaid to Prepaid
    ...
    Open WebMobile Online Tracking     ${virtual_device_1_SN}    ${virtual_device_1_IPChromeDriver}
    Select Tab    SpecialInternet
    Select On-Top Net Gift Internet Package 5GB    5GB    488Baht    30Day
    Input Friend Number    ${Number_Friend}
    Verify Submitted Request Via Wifi or Data    ${Number}    ${virtual_device_1_IPAppium}    ${virtual_device_1_Platfrom_Name}    ${virtual_device_1_Platfrom_Version}    ${virtual_device_1_SN}
    [Teardown]    Keywords For Teardown WebMobile    ${#dict_device_name}
